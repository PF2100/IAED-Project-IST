...
/*Allocates memmory and creates a Reserve*/
...
/*Recieves a vector and prints every Resere it has*/
...
/*Verifies if already exists a Reservation code similater to RevCode*/
